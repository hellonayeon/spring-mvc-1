package me.hellonayeon.springmvc.basic.requestmapping;
...
public class MappingController {
    ...
    public String mappingPath(@PathVariable String userId) { // 변수명을 다르게 하고 싶은 경우 @PathVariable("userId") String data
